...
class Database:
    ...
    def add_user(self, telegram_id: int, full_name: str, name: str = "name", surname: str = "surname", phone: str = "998999999999", language: str = "uz"):
        sql = """
        INSERT INTO Users(telegram_id, full_name, name, surname, phone, language) 
        VALUES(?, ?, ?, ?, ?, ?)
        ...
        """
        self.execute(sql, parameters=(telegram_id, full_name, name, surname, phone, language), commit=True)
